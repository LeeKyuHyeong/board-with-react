...
const Soccer = () => {
  ...
  useEffect(() => {
      ...
      try {
        await axios.get(`http://localhost:8011/api/news/soccer/${size}`)
				.then((response) => {
  ...
  return (
		<>
			...
			<div style={styles.container}>
				<h1 style={styles.header}>축구 관련 최신 뉴스<select name="size" onChange={(e) =>setSize(e.target.value)}><option value="10">10</option><option value="100">100</option></select></h1>
